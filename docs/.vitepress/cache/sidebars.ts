...
export function docsvrchatcomSidebar(): DefaultTheme.SidebarItem[] {
  return [
    {
      text: '总览',
      items: [
        ...
        { text: '额外选项', link: '/docs.vrchat.com/OVERVIEW/additional-options.md',
          collapsed: true,
          items: [
            { text: '手势切换', link: '/docs.vrchat.com/OVERVIEW/gesture-toggle.md' },
            { text: '启动选项', link: '/docs.vrchat.com/OVERVIEW/launch-options.md' },
            { text: '配置文件', link: '/docs.vrchat.com/OVERVIEW/configuration-file.md' },
            { text: 'VRChat图像性能选项', link: '/docs.vrchat.com/OVERVIEW/vrchat-configuration-window.md' },
            { text: 'VRChat 本地存储', link: '/docs.vrchat.com/OVERVIEW/local-vrchat-storage.md' },
          ],
        },
      ],
    },
      ...
      items: [
        { text: '# OSC 概览', link: '/docs.vrchat.com/VRCHAT-OSC-API/osc-overview/osc-overview.md',
          ...
          items: [
            ...
            { text: 'OSC Debugging', link: '/docs.vrchat.com/VRCHAT-OSC-API/osc-overview/osc-debugging.md' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: '升级 Unity 项目', link: '/docs.vrchat.com/WORLDS/upgrading-unity-projects/upgrading-unity-projects.md',
          collapsed: true,
          items: [
            { text: 'Migrating from 2018 LTS to 2019 LTS', link: '/docs.vrchat.com/WORLDS/upgrading-unity-projects/migrating-from-2018-lts-to-2019-lts.md' },
            { text: 'Migrating from 2017 LTS to 2018 LTS', link: '/docs.vrchat.com/WORLDS/upgrading-unity-projects/migrating-from-2017-lts-to-2018-lts.md' },
            { text: 'Migrating from 5.6 to 2017 LTS', link: '/docs.vrchat.com/WORLDS/upgrading-unity-projects/migrating-from-56-to-20174x.md' },
            { text: 'Migrating to a newer Minor Unity Version', link: '/docs.vrchat.com/WORLDS/upgrading-unity-projects/migrating-to-a-newer-minor-unity-version.md' },
          ],
        },
      ],
    },
...
export function creatorsvrchatcomSidebar(): DefaultTheme.SidebarItem[] {
  return [
    { text: '欢迎!', link: '/creators.vrchat.com/getting-started.md' },
    { text: '安装 SDK', link: '/creators.vrchat.com/sdk/sdk.md',
      collapsed: true,
      items: [
    ...
    { text: '世界', link: '/creators.vrchat.com/worlds/worlds.md',
      ...
      items: [
        ...
        { text: 'Examples', link: '/creators.vrchat.com/worlds/udon/.md',
          collapsed: true,
          items: [
        ...
        { text: 'Udon', link: '/creators.vrchat.com/worlds/udon/udon.md',
          collapsed: true,
          items: [
            { text: 'Getting Started with Udon', link: '/creators.vrchat.com/worlds/udon/getting-started-with-udon.md' },
            { text: 'Udon Node Graph', link: '/creators.vrchat.com/worlds/udon/graph/graph.md',
              collapsed: true,
              items: [
            ...
            { text: 'Data Containers', link: '/creators.vrchat.com/worlds/udon/data-containers/data-containers.md',
              collapsed: true,
              items: [
            ...
            { text: 'Midi in Udon', link: '/creators.vrchat.com/worlds/udon/midi/midi.md',
              collapsed: true,
              items: [
            ...
            { text: 'Networking', link: '/creators.vrchat.com/worlds/udon/networking/networking.md',
              collapsed: true,
              items: [
            ...
            { text: 'Player API', link: '/creators.vrchat.com/worlds/udon/players/players.md',
              collapsed: true,
              items: [
            ...
            { text: 'Video Players', link: '/creators.vrchat.com/worlds/udon/video-players/video-players.md',
              collapsed: true,
              items: [
        ...
        { text: 'VRCGraphics', link: '/creators.vrchat.com/worlds/vrc-graphics/vrc-graphics.md',
          collapsed: true,
          items: [
        ...
        { text: 'Scene Components', link: '/creators.vrchat.com/worlds/components/components.md',
          collapsed: true,
           items: [
    ...
    { text: '平台特异', link: '/creators.vrchat.com/platforms/platforms.md',
      collapsed: true,
      items: [
        { text: '安卓', link: '/creators.vrchat.com/platforms/android/android.md',
          collapsed: true,
          items: [
...
export function udonsharpdocsvrchatcomSidebar(): DefaultTheme.SidebarItem[] {
  return [
...
export function vccdocsvrchatcomSidebar(): DefaultTheme.SidebarItem[] {
  return [
