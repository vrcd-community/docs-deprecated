...
- 确保您使用的是 VRChat 的推荐 Unity 版本。（请参阅 [安装 SDK](/official-creator-docs/sdk/)）。
...
- 确保您使用的是 [正确的 Unity 版本](/official-creator-docs/sdk/current-unity-version)。
...
1. 按照[正确步骤](/official-creator-docs/sdk/updating-the-sdk)升级 SDK，关闭 Unity 并删除所有 SDK 相关文件夹及其相关的 `.meta` 文件来删除 SDK。
